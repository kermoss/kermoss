...
Pour que votre service decoder soit capable de créer un évenement à base l'arrivé d'une command il faut l'enregister et le mapper avec le subject de la dite command dans un composant that extends de la class DecoderRegistry .
