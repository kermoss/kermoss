...
public class LocalTransactionStepDefinitionTest {
    ...
    public void setUp() {
        ...
        localTransactionStepDefinitionUnderTest = new LocalTransactionStepDefinition<>(mockIn, process, mockSend, mockBlow, receivedCommand, attach, receivedCommandGTX, mockMeta);
    }
