...
public class OrderPizzaStateWorkerDummy extends GlobalTransactionWorker<OrderPizzaReceivedDummy, OrderPizzaReceivedDummy> {
    

    public OrderPizzaStateWorkerDummy() {
