...
public class OrderPizzaStateWorkerWNBDummy extends GlobalTransactionWorker<OrderPizzaReceivedDummy, OrderPizzaReceivedDummy> {
    

    public OrderPizzaStateWorkerWNBDummy() {
