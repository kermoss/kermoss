...
public class OrderPizzaStateWorkerWNInDummy extends GlobalTransactionWorker<OrderPizzaReceivedDummy, OrderPizzaReceivedDummy> {
    

    public OrderPizzaStateWorkerWNInDummy() {
