...
public class ChefCookingServiceWorkerDummy
		extends LocalTransactionWorker<OrderPizzaPendingEventDummy, OrderPizzaPendingEventDummy, ErrorLocalOccured> {

	private static final Logger log = org.slf4j.LoggerFactory.getLogger(ChefCookingServiceWorkerDummy.class);
	public ChefCookingServiceWorkerDummy() {
