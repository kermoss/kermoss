...
public class ChefCookingServiceWorkerWNBDummy
		extends LocalTransactionWorker<OrderPizzaPendingEventDummy, OrderPizzaPendingEventDummy, ErrorLocalOccured> {

	private static final Logger log = org.slf4j.LoggerFactory.getLogger(ChefCookingServiceWorkerWNBDummy.class);
	public ChefCookingServiceWorkerWNBDummy() {
	...
	public LocalTransactionStepDefinition onStart(OrderPizzaPendingEventDummy orderPizzaPendingEvent) {
		return LocalTransactionStepDefinition.builder().in(orderPizzaPendingEvent)
