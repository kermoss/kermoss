...
public class ChefCookingServiceWorkerWNInDummy
		extends LocalTransactionWorker<OrderPizzaPendingEventDummy, OrderPizzaPendingEventDummy, ErrorLocalOccured> {

	private static final Logger log = org.slf4j.LoggerFactory.getLogger(ChefCookingServiceWorkerWNInDummy.class);
	public ChefCookingServiceWorkerWNInDummy() {
