...
public class ChefCookingServiceWorkerWNRDummy
		extends LocalTransactionWorker<OrderPizzaPendingEventDummy, OrderPizzaPendingEventDummy, ErrorLocalOccured> {

	private static final Logger log = org.slf4j.LoggerFactory.getLogger(ChefCookingServiceWorkerWNRDummy.class);
	public ChefCookingServiceWorkerWNRDummy() {
