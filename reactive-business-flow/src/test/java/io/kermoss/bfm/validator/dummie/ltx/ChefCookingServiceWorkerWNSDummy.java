...
public class ChefCookingServiceWorkerWNSDummy
		extends LocalTransactionWorker<OrderPizzaPendingEventDummy, OrderPizzaPendingEventDummy, ErrorLocalOccured> {

	private static final Logger log = org.slf4j.LoggerFactory.getLogger(ChefCookingServiceWorkerWNSDummy.class);
	public ChefCookingServiceWorkerWNSDummy() {
